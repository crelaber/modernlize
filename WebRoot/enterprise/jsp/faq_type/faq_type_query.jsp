...
<div class="tools">
	...
	<div>
		<div class="easyui-panel" style="padding:5px">
	        <ul class="easyui-tree" id="dish_type_cache_tree" data-options="url:'<%=actualBasePath %>enterprise/urFaqTypeExt_getAllTreeNodelist?requestType=0',method:'get',lines:true"></ul>
	    </div>
    </div>
