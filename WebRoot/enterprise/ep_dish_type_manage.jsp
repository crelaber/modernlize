...
<script type="text/javascript" src="<%=actualBasePath %>enterprise/js/biz/ep_dish_type_manage.js"></script>
...
<body>
	...
	<form id="_form_search_default">
		...
		<ul class="seachform">
			<li><label>菜品名称</label><input name="record.suppName" type="text" class="easyui-validatebox scinput" /></li>
			<li><label>菜品类型名称</label><input name="record.managerName" type="text" class="easyui-validatebox scinput"  /></li>
			<li>	
				<label>添加时间</label>
