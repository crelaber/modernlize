...
<!-- 引入EasyUI -->
<script type="text/javascript" src="<%=actualBasePath %>enterprise/js/biz/ep_takeaway_range.js"></script>
...
<body>
	...
	<div class="place">
	    ...
	    <ul class="placeul">
		    <li><a href="#">首页</a></li>
		    <li><a href="#">外卖派送范围配置</a></li>
	    </ul>
    </div>
    
    <div class="formbody">

    <div class="formtitle"><span>外卖派送范围配置</span></div>
