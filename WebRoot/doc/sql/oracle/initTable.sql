...
prompt Creating T_UR_CAR_MODEL...
...
prompt Creating T_UR_CAR_PRODUCT_CONFIG...
...
prompt Creating T_UR_EXAM_QUESTION...
...
prompt Creating T_UR_EXAM_QUESTION_REL...
...
prompt Creating T_UR_EXAM_RESULT...
...
prompt Creating T_UR_EXAM_TYPE...
...
prompt Creating T_UR_FAQ_FILE_REL...
...
prompt Creating T_UR_FAQ_IMG_REL...
...
prompt Creating T_UR_FAQ_INTEREST...
...
prompt Creating T_UR_FAQ_STORE...
...
prompt Creating T_UR_FAQ_TMP_HOT_NEW...
...
prompt Creating T_UR_LEAVE_MSG_TO_ADMIN...
...
prompt Creating T_UR_LEAVE_MSG_TO_FAQ...
...
prompt Creating T_UR_LISTEN_LOG...
...
prompt Creating T_UR_NOT_TO_MATCH_LOG...
...
prompt Creating T_UR_PROPER_NOUN...
...
prompt Creating T_UR_SEARCH_LOG...
...
prompt Creating T_UR_SPECIAL_SHOP...
...
prompt Creating T_UR_USER_POWER...
...
prompt Creating T_UR_USER_ROLE...
...
prompt Creating T_UR_USER_ROLE_POWER...
...
prompt Creating T_UR_USER_ROLE_REL...
...
prompt Disabling triggers for T_UR_BASE_CONFIG...
alter table T_UR_BASE_CONFIG disable all triggers;
prompt Disabling triggers for T_UR_CAR_MODEL...
alter table T_UR_CAR_MODEL disable all triggers;
prompt Disabling triggers for T_UR_CAR_PRODUCT_CONFIG...
alter table T_UR_CAR_PRODUCT_CONFIG disable all triggers;
prompt Disabling triggers for T_UR_EXAM...
alter table T_UR_EXAM disable all triggers;
prompt Disabling triggers for T_UR_EXAM_QUESTION...
alter table T_UR_EXAM_QUESTION disable all triggers;
prompt Disabling triggers for T_UR_EXAM_QUESTION_REL...
alter table T_UR_EXAM_QUESTION_REL disable all triggers;
prompt Disabling triggers for T_UR_EXAM_RESULT...
alter table T_UR_EXAM_RESULT disable all triggers;
prompt Disabling triggers for T_UR_EXAM_TYPE...
alter table T_UR_EXAM_TYPE disable all triggers;
prompt Disabling triggers for T_UR_FAQ...
alter table T_UR_FAQ disable all triggers;
prompt Disabling triggers for T_UR_FAQ_FILE...
alter table T_UR_FAQ_FILE disable all triggers;
prompt Disabling triggers for T_UR_FAQ_FILE_REL...
alter table T_UR_FAQ_FILE_REL disable all triggers;
prompt Disabling triggers for T_UR_FAQ_IMG...
alter table T_UR_FAQ_IMG disable all triggers;
prompt Disabling triggers for T_UR_FAQ_IMG_REL...
alter table T_UR_FAQ_IMG_REL disable all triggers;
prompt Disabling triggers for T_UR_FAQ_INTEREST...
alter table T_UR_FAQ_INTEREST disable all triggers;
prompt Disabling triggers for T_UR_FAQ_STORE...
alter table T_UR_FAQ_STORE disable all triggers;
prompt Disabling triggers for T_UR_FAQ_TMP_HOT_NEW...
alter table T_UR_FAQ_TMP_HOT_NEW disable all triggers;
prompt Disabling triggers for T_UR_FAQ_TYPE...
alter table T_UR_FAQ_TYPE disable all triggers;
prompt Disabling triggers for T_UR_LEAVE_MSG_TO_ADMIN...
alter table T_UR_LEAVE_MSG_TO_ADMIN disable all triggers;
prompt Disabling triggers for T_UR_LEAVE_MSG_TO_FAQ...
alter table T_UR_LEAVE_MSG_TO_FAQ disable all triggers;
prompt Disabling triggers for T_UR_LISTEN_LOG...
alter table T_UR_LISTEN_LOG disable all triggers;
prompt Disabling triggers for T_UR_MSG...
alter table T_UR_MSG disable all triggers;
prompt Disabling triggers for T_UR_NOT_TO_MATCH_LOG...
alter table T_UR_NOT_TO_MATCH_LOG disable all triggers;
prompt Disabling triggers for T_UR_PROPER_NOUN...
alter table T_UR_PROPER_NOUN disable all triggers;
prompt Disabling triggers for T_UR_SEARCH_LOG...
alter table T_UR_SEARCH_LOG disable all triggers;
prompt Disabling triggers for T_UR_SPECIAL_SHOP...
alter table T_UR_SPECIAL_SHOP disable all triggers;
prompt Disabling triggers for T_UR_USER...
alter table T_UR_USER disable all triggers;
prompt Disabling triggers for T_UR_USER_POWER...
alter table T_UR_USER_POWER disable all triggers;
prompt Disabling triggers for T_UR_USER_ROLE...
alter table T_UR_USER_ROLE disable all triggers;
prompt Disabling triggers for T_UR_USER_ROLE_POWER...
alter table T_UR_USER_ROLE_POWER disable all triggers;
prompt Disabling triggers for T_UR_USER_ROLE_REL...
alter table T_UR_USER_ROLE_REL disable all triggers;
prompt Loading T_UR_BASE_CONFIG...
prompt Table is empty
prompt Loading T_UR_CAR_MODEL...
prompt Table is empty
prompt Loading T_UR_CAR_PRODUCT_CONFIG...
prompt Table is empty
prompt Loading T_UR_EXAM...
prompt Table is empty
prompt Loading T_UR_EXAM_QUESTION...
prompt Table is empty
prompt Loading T_UR_EXAM_QUESTION_REL...
prompt Table is empty
prompt Loading T_UR_EXAM_RESULT...
prompt Table is empty
prompt Loading T_UR_EXAM_TYPE...
prompt Table is empty
prompt Loading T_UR_FAQ...
prompt Table is empty
prompt Loading T_UR_FAQ_FILE...
prompt Table is empty
prompt Loading T_UR_FAQ_FILE_REL...
prompt Table is empty
prompt Loading T_UR_FAQ_IMG...
prompt Table is empty
prompt Loading T_UR_FAQ_IMG_REL...
prompt Table is empty
prompt Loading T_UR_FAQ_INTEREST...
prompt Table is empty
prompt Loading T_UR_FAQ_STORE...
prompt Table is empty
prompt Loading T_UR_FAQ_TMP_HOT_NEW...
prompt Table is empty
prompt Loading T_UR_FAQ_TYPE...
...
prompt Loading T_UR_LEAVE_MSG_TO_ADMIN...
prompt Table is empty
prompt Loading T_UR_LEAVE_MSG_TO_FAQ...
prompt Table is empty
prompt Loading T_UR_LISTEN_LOG...
prompt Table is empty
prompt Loading T_UR_MSG...
prompt Table is empty
prompt Loading T_UR_NOT_TO_MATCH_LOG...
prompt Table is empty
prompt Loading T_UR_PROPER_NOUN...
prompt Table is empty
prompt Loading T_UR_SEARCH_LOG...
prompt Table is empty
prompt Loading T_UR_SPECIAL_SHOP...
prompt Table is empty
prompt Loading T_UR_USER...
prompt Table is empty
prompt Loading T_UR_USER_POWER...
prompt Table is empty
prompt Loading T_UR_USER_ROLE...
prompt Table is empty
prompt Loading T_UR_USER_ROLE_POWER...
prompt Table is empty
prompt Loading T_UR_USER_ROLE_REL...
prompt Table is empty
prompt Enabling triggers for T_UR_BASE_CONFIG...
alter table T_UR_BASE_CONFIG enable all triggers;
prompt Enabling triggers for T_UR_CAR_MODEL...
alter table T_UR_CAR_MODEL enable all triggers;
prompt Enabling triggers for T_UR_CAR_PRODUCT_CONFIG...
alter table T_UR_CAR_PRODUCT_CONFIG enable all triggers;
prompt Enabling triggers for T_UR_EXAM...
alter table T_UR_EXAM enable all triggers;
prompt Enabling triggers for T_UR_EXAM_QUESTION...
alter table T_UR_EXAM_QUESTION enable all triggers;
prompt Enabling triggers for T_UR_EXAM_QUESTION_REL...
alter table T_UR_EXAM_QUESTION_REL enable all triggers;
prompt Enabling triggers for T_UR_EXAM_RESULT...
alter table T_UR_EXAM_RESULT enable all triggers;
prompt Enabling triggers for T_UR_EXAM_TYPE...
alter table T_UR_EXAM_TYPE enable all triggers;
prompt Enabling triggers for T_UR_FAQ...
alter table T_UR_FAQ enable all triggers;
prompt Enabling triggers for T_UR_FAQ_FILE...
alter table T_UR_FAQ_FILE enable all triggers;
prompt Enabling triggers for T_UR_FAQ_FILE_REL...
alter table T_UR_FAQ_FILE_REL enable all triggers;
prompt Enabling triggers for T_UR_FAQ_IMG...
alter table T_UR_FAQ_IMG enable all triggers;
prompt Enabling triggers for T_UR_FAQ_IMG_REL...
alter table T_UR_FAQ_IMG_REL enable all triggers;
prompt Enabling triggers for T_UR_FAQ_INTEREST...
alter table T_UR_FAQ_INTEREST enable all triggers;
prompt Enabling triggers for T_UR_FAQ_STORE...
alter table T_UR_FAQ_STORE enable all triggers;
prompt Enabling triggers for T_UR_FAQ_TMP_HOT_NEW...
alter table T_UR_FAQ_TMP_HOT_NEW enable all triggers;
prompt Enabling triggers for T_UR_FAQ_TYPE...
alter table T_UR_FAQ_TYPE enable all triggers;
prompt Enabling triggers for T_UR_LEAVE_MSG_TO_ADMIN...
alter table T_UR_LEAVE_MSG_TO_ADMIN enable all triggers;
prompt Enabling triggers for T_UR_LEAVE_MSG_TO_FAQ...
alter table T_UR_LEAVE_MSG_TO_FAQ enable all triggers;
prompt Enabling triggers for T_UR_LISTEN_LOG...
alter table T_UR_LISTEN_LOG enable all triggers;
prompt Enabling triggers for T_UR_MSG...
alter table T_UR_MSG enable all triggers;
prompt Enabling triggers for T_UR_NOT_TO_MATCH_LOG...
alter table T_UR_NOT_TO_MATCH_LOG enable all triggers;
prompt Enabling triggers for T_UR_PROPER_NOUN...
alter table T_UR_PROPER_NOUN enable all triggers;
prompt Enabling triggers for T_UR_SEARCH_LOG...
alter table T_UR_SEARCH_LOG enable all triggers;
prompt Enabling triggers for T_UR_SPECIAL_SHOP...
alter table T_UR_SPECIAL_SHOP enable all triggers;
prompt Enabling triggers for T_UR_USER...
alter table T_UR_USER enable all triggers;
prompt Enabling triggers for T_UR_USER_POWER...
alter table T_UR_USER_POWER enable all triggers;
prompt Enabling triggers for T_UR_USER_ROLE...
alter table T_UR_USER_ROLE enable all triggers;
prompt Enabling triggers for T_UR_USER_ROLE_POWER...
alter table T_UR_USER_ROLE_POWER enable all triggers;
prompt Enabling triggers for T_UR_USER_ROLE_REL...
