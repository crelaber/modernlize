...
import com.uwen.ur.model.dal.sys.UrFaqMapper;
...
@Service
@Scope("prototype")
public class UrFaqServiceImpl implements UrFaqService {
    @Autowired
    private UrFaqMapper mapper;
    ...
    public UrFaq findUrFaq(UrFaq record, MapperCallBack callback) throws Exception {
        List<UrFaq> records = listUrFaq(record, null, new Page(0, 1), callback);
    ...
    public JSONObject findUrFaqAndFkText(UrFaq record, MapperCallBack callback, FieldAppendArray appendArray) throws Exception {
        UrFaq rec = findUrFaq(record, callback);
    ...
    public JSONArray listUrFaqAndFkText(UrFaq record, String orderByClause, Page page, MapperCallBack callback, FieldAppendArray appendArray) throws Exception {
        // 属性,对应表,对应表字段
        List<UrFaq> records = listUrFaq(record, orderByClause, page, callback);
        //
    ...
    public void insertUrFaq(UrFaq record) throws Exception {
        // 执行操作
        int res = mapper.insertSelective(record);
        // 抛出异常
        if (res <= 0)
            throw new RuntimeException("UrFaq表新增数据失败");
    }
    ...
    public void dropUrFaq(UrFaq record, MapperCallBack callback) throws Exception {
        //
        callback.doRecord(record);
        //
        UrFaqExample example = new UrFaqExample();
        ...
        // 抛出异常
        if (res <= 0)
            throw new RuntimeException("UrFaq表删除数据失败");
    }
    ...
    public void modifyUrFaq(UrFaq record, MapperCallBack callback) throws Exception {
        //
        callback.doRecord(record);
        //
        UrFaqExample example = new UrFaqExample();
        ...
        // 抛出异常
        if (res <= 0) {
            throw new RuntimeException("UrFaq表更新数据失败");
        }
    ...
    public void modifyUrFaqByPkSelective(UrFaq record) throws Exception {
        // 执行操作
    ...
    public void modifyUrFaqByPk(UrFaq record) throws Exception {
        // 执行操作
    ...
    public int countUrFaq(UrFaq record, MapperCallBack callback) throws Exception {
        //
        callback.doRecord(record);
        //
        UrFaqExample example = new UrFaqExample();
