...
import com.uwen.ur.model.dal.sys.UrFaqInterestMapper;
...
import com.uwen.ur.model.pojo.sys.UrFaqInterestExample.Criteria;
import com.uwen.ur.model.service.sys.UrFaqInterestService;
...
@Service
@Scope("prototype")
public class UrFaqInterestServiceImpl implements UrFaqInterestService {
    @Autowired
    private UrFaqInterestMapper mapper;
    ...
    public UrFaqInterest findUrFaqInterest(UrFaqInterest record, MapperCallBack callback) throws Exception {
        List<UrFaqInterest> records = listUrFaqInterest(record, null, new Page(0, 1), callback);
    ...
    public JSONObject findUrFaqInterestAndFkText(UrFaqInterest record, MapperCallBack callback, FieldAppendArray appendArray) throws Exception {
        UrFaqInterest rec = findUrFaqInterest(record, callback);
    ...
    public List<UrFaqInterest> listUrFaqInterest(UrFaqInterest record, String orderByClause, Page page, MapperCallBack callback) throws Exception {
        ...
        //
        UrFaqInterestExample example = new UrFaqInterestExample();
        // 去掉重复结果集
    ...
    public JSONArray listUrFaqInterestAndFkText(UrFaqInterest record, String orderByClause, Page page, MapperCallBack callback, FieldAppendArray appendArray) throws Exception {
        // 属性,对应表,对应表字段
        List<UrFaqInterest> records = listUrFaqInterest(record, orderByClause, page, callback);
        //
    ...
    public void insertUrFaqInterest(UrFaqInterest record) throws Exception {
        // 执行操作
        int res = mapper.insertSelective(record);
        // 抛出异常
        if (res <= 0)
            throw new RuntimeException("UrFaqInterest表新增数据失败");
    }
    ...
    public void dropUrFaqInterest(UrFaqInterest record, MapperCallBack callback) throws Exception {
        //
        callback.doRecord(record);
        //
        UrFaqInterestExample example = new UrFaqInterestExample();
        ...
        // 抛出异常
        if (res <= 0)
            throw new RuntimeException("UrFaqInterest表删除数据失败");
    }
    ...
    public void modifyUrFaqInterest(UrFaqInterest record, MapperCallBack callback) throws Exception {
        //
        callback.doRecord(record);
        //
        UrFaqInterestExample example = new UrFaqInterestExample();
        ...
        // 抛出异常
        if (res <= 0) {
            throw new RuntimeException("UrFaqInterest表更新数据失败");
        }
    ...
    public void modifyUrFaqInterestByPkSelective(UrFaqInterest record) throws Exception {
        // 执行操作
    ...
    public void modifyUrFaqInterestByPk(UrFaqInterest record) throws Exception {
        // 执行操作
    ...
    public int countUrFaqInterest(UrFaqInterest record, MapperCallBack callback) throws Exception {
        //
        callback.doRecord(record);
        //
        UrFaqInterestExample example = new UrFaqInterestExample();
